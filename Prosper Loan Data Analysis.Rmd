...
qplot(x = BorrowerRate * 100, data = loanData) + facet_wrap(~Term) +
  xlab("Borrower Rate, %") +
  ggtitle("BorrowRate histograms per Terms in months")
```
...
# Reflection
Data set contains many attributes. I seleted BorrowerRate, DebtToIncomeRatio and LoanOriginalAmount as most interesting attributes.
